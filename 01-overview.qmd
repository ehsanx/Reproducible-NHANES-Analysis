...
-   **Descriptive Analysis**: Reproduces [Appendix Tables 1 & 2](07-descriptive-analysis.html#weighted-descriptive-statistics-paper-reproduction) results.
-   **Main Survival Analysis**: Establishes the primary link between smoking initiation age and mortality using **Kaplan-Meier Curves**: [Figure 1](08-survival-analysis.html#kaplan-meier-survival-analysis-figure-1). **Cox Proportional Hazards Model** results are incorporated in [Figure 2](08-survival-analysis.html#cox-proportional-hazards-models-figure-2) in the main paper.
-   **Effect Modification Analysis**: It then investigates how this relationship is modified by race/ethnicity and sex. This corresponds to [Figure 2](09-effect-modification.html#visualizing-the-results-figure-2) in the main paper and [Appendix Tables 4 and 5](09-effect-modification.html#quantifying-additive-interaction-reri) in the supplementary material.
-   **Exploratory Analysis**: Investigates the secondary relationship between the age of smoking initiation and the total duration of smoking using boxplots. This corresponds to [Appendix Figures 1-3](10-sensitivity-analysis.html#appendix-b-exploratory-analysis-of-smoking-duration) in the supplementary material.
-   **Sensitivity Analysis 1**: Adjusts for socioeconomic status (SES) proxies, such as family income and education, to check for confounding. This corresponds to [Appendix Figure 5](10-sensitivity-analysis.html#visualizing-the-ses-adjusted-results) in the supplementary material.
-   **Sensitivity Analysis 2**: Repeats the analysis on data from the 2011–2018 cycles to include the "non-Hispanic Asian" category, which was introduced in the 2011 NHANES survey. This corresponds to [Appendix Table 3](10-sensitivity-analysis.html#analysis-of-the-2011-2018-sub-period) and [Appendix Figure 4](10-sensitivity-analysis.html#visualizing-the-sub-period-results) in the supplementary material.
